...
func main() {
	...
	s, err := sentry.NewWithTags("http://b6c78f9743c944f0bbcf26c4c2c0b797:6a3584ace43b428191ffc7a16e81ff6e@localhost:9000/1", map[string]string{"service": "user"})
	if err != nil {
	...
	userSvc := user.NewUserService(db, logsvc, log)
